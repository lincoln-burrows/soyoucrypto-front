        ...
        axisPointer: {
          ...
          label: {
            formatter: function (params) {
              console.log("요기가 에러야 momentum", params.seriesData[0].data)
              return (
                (params.seriesData[0].data.length ? params.seriesData[0].data[0].toISOString().split("T")[0] :  Math.round(params.value*10000)/100 +' %')
